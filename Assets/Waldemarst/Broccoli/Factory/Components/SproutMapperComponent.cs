        ...
        private void AssignShadeVariance(TreeFactory treeFactory, SproutMap sproutMap)
        {
            ...
            while (meshDatasEnumerator.MoveNext())
            {
                ...
                if (treeFactory.meshManager.GetMesh(sproutMeshId) != null)
                {
                    ...
                    {
                        normalizedShade = Mathf.Lerp(sproutMap.minColorShade, sproutMap.maxColorShade, localUV2s[i].z);
                        ...
                        {
                            meshColor.b = Mathf.Lerp(sproutMap.minColorTint, sproutMap.maxColorTint, 1f - localUV2s[i].z);
                            meshColor.g = 0;
                        }
