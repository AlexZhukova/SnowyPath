            ...
            if (normalMode == NormalMode.FixedNormal)
            {
                for (int i = 0; i < bezierCurves.Count; i++)
                {
                    for (int j = 0; j < bezierCurves[i].samples.Count; j++)
                    {
                        ...
                        bezierCurves[i].samples[j].up = Vector3.Cross(bezierCurves[i].samples[j].forward, fixedNormal);
                    }
                }
                for (int i = 0; i < points.Count; i++)
                {
                    points[i].normal = fixedNormal;
                    points[i].up = Vector3.Cross(points[i].forward, fixedNormal);
                }
            }
            else
            {
                ...
                for (int i = 0; i < bezierCurves.Count; i++)
                {
                    for (int j = 0; j < bezierCurves[i].samples.Count; j++)
                    {
                        ...
                        bezierCurves[i].samples[j].up = Vector3.Cross(bezierCurves[i].samples[j].forward, bezierCurves[i].samples[j].normal);
                    }
                }
                for (int i = 0; i < points.Count; i++)
                {
                    ...
                    points[i].up = Vector3.Cross(points[i].forward, points[i].normal);
                }
            }
        }
