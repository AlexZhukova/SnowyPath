    ...
    public class BezierCurveEditor { 
        ...
        */
            ...
            switch (ctrlToDraw) {
                case ControlType.FreeMove:
                    ...
                    if (node.isSelected) {
                        ...
                        if (rayDragEnabled) {
                            var fmh_1164_78_638146519738672936 = Quaternion.identity; newPosition = Handles.FreeMoveHandle (s_tmpNode, handleSize * nodeSize, Vector3.zero, selectedNodeDrawFunction);
                        } else {
        ...
        void DrawBezierNodeHandle1 (BezierNode node, int index, Vector3 sceneOffset, float scale, bool isLastNode) {
            ...
            var fmh_1323_17_638146519738712883 = Quaternion.identity; Vector3 newGlobal1 = Handles.FreeMoveHandle (
                s_tmpHandle1, 
        ...
        void DrawBezierNodeHandle2 (BezierNode node, int index, Vector3 sceneOffset, float scale, bool isLastNode) {
            ...
            var fmh_1364_17_638146519738717195 = Quaternion.identity; Vector3 newGlobal2 = Handles.FreeMoveHandle(
                s_tmpHandle2, 
