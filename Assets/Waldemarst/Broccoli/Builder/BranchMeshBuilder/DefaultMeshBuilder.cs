...
namespace Broccoli.Builder
{
    ...
    public class DefaultMeshBuilder : IBranchMeshBuilder
    {
        ...
        {
            return GetPolygonAt(branchSkin.id, branchSkin.centersPos[segmentIndex], branchSkin.directionsPosAtSkin[segmentIndex], branchSkin.upsGirths[segmentIndex],
                branchSkin.upsGirths[segmentIndex].w, (int)branchSkin.idsSegs[segmentIndex].z, ref radialPositions, scale, radiusScale);
        }
        /// <summary>
