...
namespace Broccoli.Builder
{
    ...
    /// 2. UV mapping 0-1 values on the XY and width/height values on the ZW coordinates.
    /// 3. UV2 mapping with gradient values from center to vertex, length on X and 0-1 on Y coordinate.
    /// </summary>
