...
namespace Broccoli.Utils
{
    ...
    public static class GUITextureManager
    {
        ...
        private static Dictionary<GUIElement, string> texturePath = new Dictionary<GUIElement, string>() {
            ...
            {GUIElement.IconInfo, "Broccoli/GUI/broccoli_icons.png"},
            {GUIElement.IconDoc, "Broccoli/GUI/broccoli_icons.png"},
            {GUIElement.IconGradient, "Broccoli/GUI/broccoli_icons.png"},
        };
        /// <summary>
